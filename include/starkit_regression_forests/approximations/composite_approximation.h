...
public:
  ...
  static std::unique_ptr<Approximation> weightedMerge(std::shared_ptr<const Approximation> a1, double weight1,
  ...
  static double avgDifference(std::shared_ptr<const Approximation> a1, std::shared_ptr<const Approximation> a2,
