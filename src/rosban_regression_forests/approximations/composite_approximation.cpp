  ...
  namespace RegressionTree {
                                               ...
                                               std::pair<double, Eigen::VectorXd>& best) const
    {
      ...
      for (Approximation * a : approximations) {
        ...
        if (pwcA == NULL) {
          throw std::runtime_error("CompositeApproximation: getMax of node is only implemented for PWCApproximation yet");
        }
    ...
    Approximation *
    CompositeApproximation::weightedMerge(Approximation * a1, double weight1,
                                          Approximation * a2, double weight2)
    {
      // Catching types
    ...
    double CompositeApproximation::difference(const Approximation * a1,
                                              const Approximation * a2)
    {
