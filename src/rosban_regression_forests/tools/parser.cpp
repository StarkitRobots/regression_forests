...
namespace Math {
  namespace RegressionTree {
    namespace Parser {
      ...
      Approximation * approximation(const std::string & s,
                                    size_t * index)
      {
      ...
      OrthogonalSplit orthogonalSplit(const std::string & s,
                                      size_t * index)
      {
      ...
      RegressionNode * regressionNode(const std::string & s,
                                      size_t * index)
      {
      ...
      std::unique_ptr<RegressionTree> regressionTree(const std::string & s,
                                                     size_t * index)
      {
      ...
      std::unique_ptr<RegressionForest> regressionForest(const std::string & s,
                                                         size_t * index)
      {
